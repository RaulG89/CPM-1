...
/**
 * Clase 'Pel�cula' para el m�dulo entregable de CPM. Esta clase contiene todos
 * los datos de una pel�cula determinada
 * 
 * @author UO236852
 *
 */
public class Movie {
	/**
	 * C�digo interno de la pel�cula (no para mostrar al usuario) Nota: Puede
	 * que no se use nunca
	 */
	...
	/**
	 * M�todo que crea una pel�cula a partir de una l�nea de datos le�da del
	 * fichero y la devuelve
	 * 
	 * @param line
	...
	/**
	 * M�todo que devuelve un vector de cadenas con los detalles de la pel�cula
	 * para mostrar en la pantalla de selecci�n de pel�cula. El vector contiene,
	 * por este orden, t�tulo, g�nero, edad recomendada, duraci�n y formato.
	 * 
	...
	public String getDetailsForScreen1(String locale) {
		...
		if (locale.equals("es")) {
			...
			detalles.add(
					"Duraci�n: " + String.valueOf(this.duracion) + " minutos");
			if (this.is3d)
	...
	/**
	 * M�todo que devuelve un vector de cadenas con las fechas de proyecci�n de
	 * la pel�cula
	 * 
	...
	/**
	 * M�todo que devuelve un vector de cadenas con las horas de proyecci�n de
	 * la pel�cula
	 * 
