...
/**
 * Clase que almacena un momento. Cada momento se compone de
...
public class Moment {
	 ...
	 * @param date Fecha en formato corto
	 * @param wk Índice que cuenta el día de la semana
	 * @param hour Hora en formato corto
	 */
	...
	/**
	 * Método que devuelve la fecha de este momento para
	...
	/**
	 * Método que devuelve la hora de este momento para
	 * el idioma correspondiente
	 * @param locale Idioma
	...
	/**
	 * Método que devuelve la combinación 'fecha-hora' de
	 * este momento en un formato no legible para el idioma
	 * correspondiente. Nota: Puede que este método no se use
	 * @param locale Idioma
