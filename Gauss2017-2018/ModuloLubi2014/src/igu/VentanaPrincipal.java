...
public class VentanaPrincipal extends JFrame {
	...
	/**
	 * M�todo que elimina los pedidos seleccionados por el cliente y reforma la
	 * ventana de Revisi�n de Compra con los que quedan
	 */
	...
	private void translate() {
		...
		ckCumpleaños.setText(txt.getString("ckCumplea�os"));
		ckCumpleaños.setToolTipText(txt.getString("ckCumplea�os_tt"));
	...
	/**
	 * M�todo que ajusta y coloca una imagen como icono de un componente seg�n
	 * su tama�o
	 * 
	 * @param component
	 *            Componente
	...
	class S4LeftButtonActionListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			// Si estamos en modo Revisi�n, comprar entradas para otra pel�cula
			if (screen4mode == MODE_REVIEW) {
	...
	/**
	 * Clase que controla la selecci�n de pedidos en la ventana de Revisi�n de
	 * Compra
	 */
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			for (Moment m : momentos)
				if (m.getDate(locale.toLanguageTag()).equals(fecha)
					...
					pedido.setMomento(m);
			/**
			 * Como ya tenemos el momento, podemos conseguir la ocupaci�n de las
			 * butacas apropiadas
			 */
