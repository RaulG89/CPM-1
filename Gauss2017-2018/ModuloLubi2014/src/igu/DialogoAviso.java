...
public class DialogoAviso extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public DialogoAviso(VentanaPrincipal main, String title, Icon icon, String mensaje, String boton1, String boton2) {
		setResizable(false);
		this.main = main;
		setIconImage(Toolkit.getDefaultToolkit().getImage(DialogoAviso.class.getResource("/img/Azur.png")));
	...
	public DialogoAviso(VentanaPrincipal main, String title, Icon icon, String mensaje, String boton) {
		setResizable(false);
		this.main = main;
		setIconImage(Toolkit.getDefaultToolkit().getImage(DialogoAviso.class.getResource("/img/Azur.png")));
		BorderLayout borderLayout = (BorderLayout) getContentPane().getLayout();
