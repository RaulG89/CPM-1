...
public class VentanaPrincipal extends JFrame {
	...
	public JTable getTablaCamarotes() {
		if (tablaCamarotes == null) {
			modeloTablaCamarotes = new DefaultTableModel(
					new Object[] { "Tipo", "Situación", "Pasajeros", "Extras" },
					0);
	...
	public void crearResumen() {
		...
		if (descuento) {
			descuentoCamrotes = (float) ((precioCamarotes + precioExtras)
					* 0.15);
			aux += "Descuento añadido por reserva de más de 4 camortes:"
					+ descuentoCamrotes;
		}
		aux += "\nImporte Total:				" + (precioCamarotes
				+ precioExtras - precioDescuento - descuentoCamrotes) + " €\n";
