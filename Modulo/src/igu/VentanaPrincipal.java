...
public class VentanaPrincipal extends JFrame {
			...
			public void run() {
				try {
					...
					SubstanceLookAndFeel
							.setSkin("org.jvnet.substance.skin.BusinessBlueSteelSkin");
	...
	public VentanaPrincipal() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				VentanaPrincipal.class.getResource("/img/Fin.jpg")));
	...
	private JButton getBtnCastellano() {
		if (btnCastellano == null) {
			...
			btnCastellano
					.setToolTipText("Cambia el idioma de la aplicaci\u00F3n a castellano");
			...
			btnCastellano.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					JOptionPane
							.showMessageDialog(
									null,
									"En estos momentos nuestra aplicación solo esta disponible en castellano.\nLamentamos las molestias.",
	...
	private JButton getBtnIngles() {
		if (btnIngles == null) {
			...
			btnIngles
					.setToolTipText("Cambia el idioma de la aplicaci\u00F3n a ingl\u00E9s");
			...
			btnIngles.setIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/ingles.jpg")));
		}
		return btnIngles;
	}
	...
	private JButton getBtnFrances() {
		if (btnFrances == null) {
			...
			btnFrances
					.setToolTipText("Cambia el idioma de la aplicaci\u00F3n a franc\u00E9s");
			...
			btnFrances.setIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/frances.jpg")));
		}
		return btnFrances;
	}
	...
	private JButton getBtnAleman() {
		if (btnAleman == null) {
			...
			btnAleman
					.setToolTipText("Cambia el idioma de la aplicaci\u00F3n a alem\u00E1n");
			btnAleman.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					JOptionPane
							.showMessageDialog(
									null,
									"Gerade jetzt unsere Anwendung ist nur auf Spanisch erhältlich.\n Es tut uns leid für die Unannehmlichkeiten.",
									"Aufmerksamkeit",
									JOptionPane.INFORMATION_MESSAGE);
				}
			});
			btnAleman.setBackground(Color.WHITE);
			btnAleman.setIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/aleman.jpg")));
		}
		return btnAleman;
	}
	...
	private JLabel getLblListaCrucerosDisponibles() {
		if (lblListaCrucerosDisponibles == null) {
			...
			lblListaCrucerosDisponibles.setFont(new Font("Tahoma", Font.PLAIN,
					40));
		}
	...
	private JButton getBtnSiguienteListaCruceros() {
		if (btnSiguienteListaCruceros == null) {
			...
			btnSiguienteListaCruceros
					.setToolTipText("Muestra los detalles del crucero seleccionado");
			...
			btnSiguienteListaCruceros.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (crucero != null) {
						...
						if (txtPlazasDoblesExteriores.getText().equals(
								"0 libres")
								&& txtPlazasDoblesInteriores.getText().equals(
										"0 libres")
	...
	private void comprobarPlazasDisponibleCrucero() {
		ArrayList<Camarote> camarotes = crucero.getPasajerosFechas().get(
				cbFechas.getSelectedIndex());
	...
	private JComboBox<String> getCbOpciones() {
		if (cbOpcionesFiltros == null) {
			...
			cbOpcionesFiltros
					.setToolTipText("Selecciona la caracteristica por la cual se van ha filtrar los cruceros");
			...
			cbOpcionesFiltros.setModel(new DefaultComboBoxModel<String>(
					opciones));
		}
	...
	private void crearFiltros() {
		...
		} else if (cbOpcionesFiltros.getSelectedItem().equals(
				"Puerto de salida")) {
	...
	private void agregarTablaPrecio() {
		...
		float precioDesde = Float.parseFloat(desdeString.substring(0,
				desdeString.length() - 2));
		String hastaString = (String) hasta.getSelectedItem();
		float precioHasta = Float.parseFloat(hastaString.substring(0,
				desdeString.length() - 2));
		for (Crucero crucero : catalogo.getCruceros()) {
	...
	private JTable getTablaCruceros() {
		if (tablaCruceros == null) {
			modeloTablaCruceros = new DefaultTableModel(new Object[] { "Zona",
					"Puerto de salida", "Itinerario", "Admisión de menores",
					"Dias de duración", "Fechas", "Barco", "Descuento",
					"Seleccionado" }, 0);
			...
			tablaCruceros.getColumn("Seleccionado").setCellRenderer(
					new RadioButtonRenderer());
			tablaCruceros.getColumn("Seleccionado").setCellEditor(
	...
	private JButton getBtnAtrasDetallesCrucero() {
		if (btnAtrasDetallesCrucero == null) {
			...
			btnAtrasDetallesCrucero
					.setToolTipText("Vuelve a la pantalla de selecci\u00F3n de cruceros");
	...
	private JButton getBtnSiguienteDetallesCrucero() {
		if (btnSiguienteDetallesCrucero == null) {
			...
			btnSiguienteDetallesCrucero.setFont(new Font("Tahoma", Font.PLAIN,
					12));
	...
	private JButton getBtnCancelarDetallesCrucero() {
		if (btnCancelarDetallesCrucero == null) {
			...
			btnCancelarDetallesCrucero
					.setToolTipText("Borra todos los datos vuelve a la pantalla de inicio");
			btnCancelarDetallesCrucero.setFont(new Font("Tahoma", Font.PLAIN,
					12));
	...
	private JTextArea getTxtAreaDescripcion() {
		if (txtAreaDescripcion == null) {
			...
			txtAreaDescripcion
					.setToolTipText("Muestra la descripci\u00F3n del crucero seleccionado");
	...
	private JPanel getPnPrecioDobleInterior() {
		if (pnPrecioDobleInterior == null) {
			...
			pnPrecioDobleInterior.setLayout(new FlowLayout(FlowLayout.RIGHT, 5,
					5));
	...
	private JTextField getTxtPrecioDobleInterior() {
		if (txtPrecioDobleInterior == null) {
			...
			txtPrecioDobleInterior
					.setToolTipText("Muestra el precio de un camarote doble interior");
	...
	private JTextField getTxtPrecioDobleExterior() {
		if (txtPrecioDobleExterior == null) {
			...
			txtPrecioDobleExterior
					.setToolTipText("Muestra el precio de un camarote doble exterior");
	...
	private JTextField getTxtPrecioFamiliarInterior() {
		if (txtPrecioFamiliarInterior == null) {
			...
			txtPrecioFamiliarInterior
					.setToolTipText("Muestra el precio de un camarote familiar interior");
			txtPrecioFamiliarInterior
					.setFont(new Font("Tahoma", Font.PLAIN, 12));
	...
	private JTextField getTxtPrecioFamiliarExterior() {
		if (txtPrecioFamiliarExterior == null) {
			...
			txtPrecioFamiliarExterior
					.setToolTipText("Muestra el precio de un camarote familiar exterior");
			txtPrecioFamiliarExterior
					.setFont(new Font("Tahoma", Font.PLAIN, 12));
	...
	private JLabel getLblCamarotesDoblesInteriores() {
		if (lblCamarotesDoblesInteriores == null) {
			...
			lblCamarotesDoblesInteriores.setFont(new Font("Tahoma", Font.PLAIN,
					12));
		}
	...
	private JLabel getLblCamarotesDoblesExteriores() {
		if (lblCamarotesDoblesExteriores == null) {
			...
			lblCamarotesDoblesExteriores.setFont(new Font("Tahoma", Font.PLAIN,
					12));
		}
	...
	private JLabel getLblCamarotesFamiliarInteriores() {
		if (lblCamarotesFamiliarInteriores == null) {
			...
			lblCamarotesFamiliarInteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
		}
	...
	private JTextField getTxtPlazasFamiliaresInteriores() {
		if (txtPlazasFamiliaresInteriores == null) {
			...
			txtPlazasFamiliaresInteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
	...
	private JLabel getLblCamarotesFamiliarExterior() {
		if (lblCamarotesFamiliarExterior == null) {
			...
			lblCamarotesFamiliarExterior.setFont(new Font("Tahoma", Font.PLAIN,
					12));
		}
	...
	private JTextField getTxtPlazasFamiliaresExteriores() {
		if (txtPlazasFamiliaresExteriores == null) {
			...
			txtPlazasFamiliaresExteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
	...
	private JButton getBtnAtrasPasajeros() {
		if (btnAtrasPasajeros == null) {
			...
			btnAtrasPasajeros
					.setToolTipText("Vuelve a la pantalla de detalles del crucero");
	...
	public JButton getBtnSiguientePasajeros() {
		if (btnSiguientePasajeros == null) {
			...
			btnSiguientePasajeros
					.setToolTipText("Muestra la ventana de reserva de camarotes");
	...
	private JPanel getPnBotonesModificarPasajeros() {
		if (pnBotonesModificarPasajeros == null) {
			...
			pnBotonesModificarPasajeros.setLayout(new FlowLayout(
	...
	private JButton getBtnAñadirPasajero() {
		if (btnAñadirPasajero == null) {
			...
			btnAñadirPasajero
					.setToolTipText("A\u00F1ade un pasajero a la lista de pasajero de la reserva");
	...
	public JButton getBtnBorrarPasajero() {
		if (btnBorrarPasajero == null) {
			...
			btnBorrarPasajero
					.setToolTipText("Borra al pasajero seleccionado de la lista de pasajeros de la reserva");
			...
			cbFechas.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if (txtPlazasDoblesExteriores.getText().equals("0 libres")
							&& txtPlazasDoblesInteriores.getText().equals(
									"0 libres")
							&& txtPlazasFamiliaresExteriores.getText().equals(
									"0 libres")
							&& txtPlazasFamiliaresInteriores.getText().equals(
									"0 libres"))
						btnSiguienteDetallesCrucero.setEnabled(false);
					else
	...
	private JPanel getPnEspacio2ReservaCamarotes() {
		if (pnEspacio2ReservaCamarotes == null) {
			...
			pnEspacio2ReservaCamarotes.setLayout(new FlowLayout(
					FlowLayout.CENTER, 5, 5));
	...
	public JButton getBtnSiguienteReservaCamarotes() {
		if (btnSiguienteReservaCamarotes == null) {
			...
			btnSiguienteReservaCamarotes
					.setToolTipText("Muestra la ventana para asignar a un pasajero la reserva");
			btnSiguienteReservaCamarotes.setFont(new Font("Tahoma", Font.PLAIN,
					12));
			btnSiguienteReservaCamarotes.setEnabled(false);
			btnSiguienteReservaCamarotes
					.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if (modeloTablaCamarotes.getRowCount() >= 4) {
								descuento = true;
								JOptionPane
										.showMessageDialog(null,
												"Al haber reservado 4 o más camarotes tiene un descuento adicional del 15%");
							}
	...
	private JButton getBtnCancelarReservaCamarotes() {
		if (btnCancelarReservaCamarotes == null) {
			...
			btnCancelarReservaCamarotes.setFont(new Font("Tahoma", Font.PLAIN,
					12));
	...
	public JTable getTablaCamarotes() {
		if (tablaCamarotes == null) {
			modeloTablaCamarotes = new DefaultTableModel(new Object[] { "Tipo",
					"Situación", "Pasajeros", "Extras" }, 0);
	...
	public JButton getBtnAñadirReservaCamarotes() {
		if (btnAñadirReservaCamarotes == null) {
			...
			btnAñadirReservaCamarotes
					.setToolTipText("A\u00F1ade un camarote a la lista de camarotes de la reserva");
			...
			btnBorrarReservaCamarotes.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (camarote == -1)
						...
						Camarote aux = buscarCamarote(listaCamarotes
								.get(camarote));
	...
	private Camarote buscarCamarote(Camarote camarote) {
		...
		for (Camarote a : crucero.getPasajerosFechas().get(
				cbFechas.getSelectedIndex())) {
	...
	private JButton getBtnAtrasResumen() {
		if (btnAtrasResumen == null) {
			...
			btnAtrasResumen
					.setToolTipText("Vuelve a la venta de modificaci\u00F3n de la lista de camarotes");
	...
	public void crearResumen() {
		...
		aux += "Días: " + crucero.getDuracionDias() + "\n";
		...
		aux += "\n	** PAGADO RESERVA **\n";
		aux += "Camarotes:				" + precioCamarotes + " €\n";
		aux += "Extras:					" + precioExtras + " €\n";
		if (crucero.isDescuento()) {
			precioDescuento = (float) ((precioCamarotes + precioExtras) * 0.15);
			aux += "Descuento:				" + precioDescuento + " €\n";
		}
		float descuentoCamrotes = 0;
		if (descuento) {
			descuentoCamrotes = (float) ((precioCamarotes + precioExtras) * 0.15);
			aux += "Descuento añadido por reserva de más de 4 camortes:"
					+ descuentoCamrotes;
		}
		aux += "\nImporte Total:				"
				+ (precioCamarotes + precioExtras - precioDescuento - descuentoCamrotes)
				+ " €\n";
	...
	public void grabarReserva(String nombreFichero) {
		try {
			BufferedWriter fichero = new BufferedWriter(new FileWriter(
					"files/reservas/" + nombreFichero + ".dat"));
	...
	private JButton getBtnFinalizar() {
		if (btnFinalizar == null) {
			...
			btnFinalizar
					.setToolTipText("Finaliza la reserva y vuelve a la pantalla de inicio");
	...
	private JButton getBtnMostrar() {
		if (btnMostrar == null) {
			...
			btnMostrar
					.setToolTipText("Muestra todos los detalles del barco del crucero");
