...
public class VentanaAñadirPasajero extends JDialog {
	...
	private JButton getBtnAgregar() {
		if (btnAgregar == null) {
			...
			btnAgregar
					.setToolTipText("A\u00F1ade un pasajero a la lista de pasajeros");
			btnAgregar.setMnemonic('A');
			btnAgregar.setFont(new Font("Tahoma", Font.PLAIN, 12));
			btnAgregar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Pasajero pasajero = new Pasajero(txtNombrePasajero
							.getText(), txtPrimerApellido.getText() + " "
							+ txtSegundoApellido.getText(), txtDniPasajero
							.getText(), cbDia.getSelectedItem() + "-"
							+ (cbMes.getSelectedIndex() + 1) + "-"
							+ cbAño.getSelectedItem(), txtObservaciones
							.getText());
					...
					if (!añadido) {
						...
						vp.getModeloListaPasajeros().addRow(
								new Object[] { pasajero.getNombre(),
										pasajero.getApellidos(),
										pasajero.getDni(),
										pasajero.getFechaNacimiento() });
	...
	private JTextField getTxtPrimerApellido() {
		if (txtPrimerApellido == null) {
			...
			txtPrimerApellido
					.setToolTipText("Introduzca aqui el primer apellido del pasajero");
	...
	private JTextField getTxtSegundoApellido() {
		if (txtSegundoApellido == null) {
			...
			txtSegundoApellido
					.setToolTipText("Introduzca aqui el segundo apellido del pasajero");
	...
	private JComboBox<String> getCbAño() {
		if (cbAño == null) {
			...
			cbAño.setToolTipText("A\u00F1o de la fecha de nacimiento del pasajero");
	...
	private JTextArea getTxtObservaciones() {
		if (txtObservaciones == null) {
			...
			txtObservaciones
					.setToolTipText("Indique si el pasajero tiene alguna enfermedad o alg\u00FAn dato de interes");
