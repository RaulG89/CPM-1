...
public class VentanaDetallesBarco extends JDialog {
	...
	private JButton getBtnAtras() {
		if (btnAtras == null) {
			...
			btnAtras.setToolTipText("Cierra esta ventana y vuelve a la ventan principal");
	...
	private PanelImagenRedimensionable getPnImagen() {
		if (pnImagen == null) {
			pnImagen = new PanelImagenRedimensionable(crucero.getBarco()
					.getCodigo());
		}
		return pnImagen;
	}
	...
	private JTextField getTxtNombre() {
		if (txtNombre == null) {
			...
			txtNombre
					.setToolTipText("Nombre del barco en el que se realiza el crucero");
	...
	private JTextArea getTxtAreaDescripcion() {
		if (txtAreaDescripcion == null) {
			...
			txtAreaDescripcion
					.setToolTipText("Descripci\u00F3n del barco en el que se realiza el crucero");
	...
	private JTextField getTxtCamarotesDoblesExteriores() {
		if (txtCamarotesDoblesExteriores == null) {
			...
			txtCamarotesDoblesExteriores
					.setToolTipText("N\u00FAmero de camarotes dobles exteriores del barco");
			txtCamarotesDoblesExteriores.setFont(new Font("Tahoma", Font.PLAIN,
					12));
	...
	private JTextField getTxtCamarotesDoblesInteriores() {
		if (txtCamarotesDoblesInteriores == null) {
			...
			txtCamarotesDoblesInteriores
					.setToolTipText("N\u00FAmero de camarotes dobles interiores del barco");
			txtCamarotesDoblesInteriores.setFont(new Font("Tahoma", Font.PLAIN,
					12));
	...
	private JLabel getLblCamarotesFamiliaresExteriores() {
		if (lblCamarotesFamiliaresExteriores == null) {
			...
			lblCamarotesFamiliaresExteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
		}
	...
	private JLabel getLblCamarotesFamiliaresInteriores() {
		if (lblCamarotesFamiliaresInteriores == null) {
			...
			lblCamarotesFamiliaresInteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
		}
	...
	private JTextField getTxtCamarotesFamiliaresExteriores() {
		if (txtCamarotesFamiliaresExteriores == null) {
			...
			txtCamarotesFamiliaresExteriores
					.setToolTipText("N\u00FAmero de camarotes familiares exteriores del barco");
			txtCamarotesFamiliaresExteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
	...
	private JTextField getTxtCamarotesFamiliaresInteriores() {
		if (txtCamarotesFamiliaresInteriores == null) {
			...
			txtCamarotesFamiliaresInteriores
					.setToolTipText("N\u00FAmero de camarotes familiares interiores del barco");
			txtCamarotesFamiliaresInteriores.setFont(new Font("Tahoma",
					Font.PLAIN, 12));
			...
			btnMostrarCapitan.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					JOptionPane.showMessageDialog(null,
							"El capitan del barco es "
									+ crucero.getBarco().getCapitan()
											.getNombre());
				}
			});
		}
