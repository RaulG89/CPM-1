...
public class VentanaRegistro extends JDialog {
	...
	public VentanaRegistro(VentanaPrincipal vp) {
		...
		// Elimina el objeto actual y lo deja como esta
	...
	private JComboBox<String> getCbMes() {
		if (cbMes == null) {
			...
			cbMes.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					String aux = (String) cbMes.getSelectedItem();
					String[] dias;
					if (aux.equals("Enero") || aux.equals("Marzo")
							|| aux.equals("Mayo") || aux.equals("Julio")
							|| aux.equals("Agosto") || aux.equals("Octubre")
							|| aux.equals("Diciembre")) {
						dias = new String[31];
						for (int i = 0; i < 31; i++)
							dias[i] = "" + (i + 1);
