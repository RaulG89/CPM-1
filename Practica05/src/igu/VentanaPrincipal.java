...
public class VentanaPrincipal extends JFrame {
	...
	private JButton getBtnLiebre00() {
		if (btnLiebre00 == null) {
			...
			btnLiebre00.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
			...
			btnLiebre00.setIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
		}
		return btnLiebre00;
	}
	...
	private JButton getBtnLiebre01() {
		if (btnLiebre01 == null) {
			...
			btnLiebre01.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre02() {
		if (btnLiebre02 == null) {
			...
			btnLiebre02.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre03() {
		if (btnLiebre03 == null) {
			...
			btnLiebre03.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre04() {
		if (btnLiebre04 == null) {
			...
			btnLiebre04.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre05() {
		if (btnLiebre05 == null) {
			...
			btnLiebre05.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre06() {
		if (btnLiebre06 == null) {
			...
			btnLiebre06.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre07() {
		if (btnLiebre07 == null) {
			...
			btnLiebre07.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre08() {
		if (btnLiebre08 == null) {
			...
			btnLiebre08.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre09() {
		if (btnLiebre09 == null) {
			...
			btnLiebre09.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnLiebre10() {
		if (btnLiebre10 == null) {
			...
			btnLiebre10.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/liebre.JPG")));
	...
	private JButton getBtnTortuga00() {
		if (btnTortuga00 == null) {
			...
			btnTortuga00.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
			...
			btnTortuga00.setIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
		}
		return btnTortuga00;
	}
	...
	private JButton getBtnTortuga01() {
		if (btnTortuga01 == null) {
			...
			btnTortuga01.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga02() {
		if (btnTortuga02 == null) {
			...
			btnTortuga02.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga03() {
		if (btnTortuga03 == null) {
			...
			btnTortuga03.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga04() {
		if (btnTortuga04 == null) {
			...
			btnTortuga04.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga05() {
		if (btnTortuga05 == null) {
			...
			btnTortuga05.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga06() {
		if (btnTortuga06 == null) {
			...
			btnTortuga06.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga07() {
		if (btnTortuga07 == null) {
			...
			btnTortuga07.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga08() {
		if (btnTortuga08 == null) {
			...
			btnTortuga08.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga09() {
		if (btnTortuga09 == null) {
			...
			btnTortuga09.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
	...
	private JButton getBtnTortuga10() {
		if (btnTortuga10 == null) {
			...
			btnTortuga10.setDisabledIcon(new ImageIcon(VentanaPrincipal.class
					.getResource("/img/tortuga.JPG")));
