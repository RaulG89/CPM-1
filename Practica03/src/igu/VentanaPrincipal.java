...
public class VentanaPrincipal extends JFrame {
	...
	private JComboBox<Articulo> getCbArticulos() {
		if (cbArticulos == null) {
			...
			cbArticulos.setModel(new DefaultComboBoxModel<Articulo>(catalogo
					.getArticulos()));
	...
	private JTextField getTxtCantidad() {
		if (txtCantidad == null) {
			...
			txtCantidad.addFocusListener(new FocusAdapter() {
				@Override
				public void focusGained(FocusEvent arg0) { // Se rellena cuando se selecciona el campo
	...
	private JButton getBtnAñadir() {
		if (btnAñadir == null) {
			...
			btnAñadir.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if (!txtCantidad.getText().equals("")) {
						...
						txtPrecio.setText(String.valueOf(precioPedido) + " \u20AC");
			...
			btnAñadir
					.setToolTipText("A\u00F1ade elementos a la cesta de compra");
