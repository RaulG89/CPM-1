...
/**
 * Clase 'Cine' para el módulo entregable de CPM.
 * La clase cine administra todo el tinglado a alto nivel.
 * @author UO236852
 *
 */
public class Cinema {
	...
	/**
	 * Constructor para la clase 'Cine' que carga los datos y prepara un nuevo cliente
	 * @throws IOException Algo malo ha pasado
	 */
	public Cinema() throws IOException {
		...
		BufferedReader sr = new BufferedReader(new FileReader("bin/files/precios.dat"));
		while(sr.ready()) {
			...
			System.out.println(" Incremento cumpleaños: " + Float.valueOf(ptr[3]));
			float pjb = Float.valueOf(ptr[4]);
			System.out.println(" Incremento jubilados: " + Float.valueOf(ptr[4]));
