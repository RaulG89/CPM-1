...
public class VentanaRegistro extends JFrame {
	...
	private final ButtonGroup buttonGroupSexo = new ButtonGroup(); // Para hacer que solo se pueda elegir un boton entre varias opciones
	...
	public VentanaRegistro() {
		...
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Configura la x para cerrar la ventana
		...
		if (btnAceptar == null) {
			...
			btnAceptar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (tfNombre.getText().equals(""))
					...
					else if (String.valueOf(pfPassword.getPassword()).length() < 5)
						JOptionPane
								.showMessageDialog(null,
										"EL campo 'Password' contener más de 5 caracteres");
						...
						JOptionPane
								.showMessageDialog(null,
										"EL campo 'Reintroduzca Password' contener más de 5 caracteres");
					else if (!(String.valueOf(pfPassword.getPassword())
