...
public class Parque {
	...
	public Parque(String codigo, String denominacion, String pais, String localidad, String descripcion,Entrada entrada) {
		this.codigo = codigo;
	...
	public String toString() {
		return "Parque [codigo=" + codigo + ", denominacion=" + denominacion + ", pais=" + pais + ", localidad="
